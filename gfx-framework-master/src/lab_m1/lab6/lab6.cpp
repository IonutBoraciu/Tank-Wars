...
void Lab6::Init()
{
    ...
    // Create a simple cube
    {
        ...
        CreateMesh("cube", vertices, indices,glm::vec3(1,0,0));
    }
...
Mesh* Lab6::CreateMesh(const char *name, const std::vector<VertexFormat> &vertices, const std::vector<unsigned int> &indices, const glm::vec3& color)
{
    unsigned int VAO = 0;
    ...
    // ========================================================================
    GLint object_color_loc = glGetUniformLocation(shaders["LabShader"]->program, "object_color");
...
void Lab6::Update(float deltaTimeSeconds)
{
...

    {
     ...
     vertices.push_back(VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0)));
     vertices.push_back(VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 0)));

     indices.push_back(0);
     indices.push_back(1);
     indices.push_back(2);

     //Mesh* mesh = new Mesh("smallSquare");
     //mesh->InitFromData(vertices, indices);
     //AddMeshToList(mesh
     CreateMesh("smallSquare", vertices, indices,glm::vec3(1,0,0));
     RenderSimpleMesh(meshes["smallSquare"], shaders["LabShader"], modelMatrix);
...
void Lab6::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix)
{
    ...
    int timeLocation = glGetUniformLocation(shader->program, "eTime");
